...
final String _appleBundleId = "baseairdroper.base.com";
final String _googleMapsApiKey = "_BASEAIRDROPER_API_KEY_";
final _googleApiHeaders = {"x-ios-bundle-identifier": _appleBundleId};

//Platform.environment['API_KEY']

final prodApiProxy =
    "https://europe-west2-basedotcom.cloudfunctions.net/BaseAirdroperWebDemo";
