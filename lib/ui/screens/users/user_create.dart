import 'dart:io';
import 'package:airdroper_crm/bloc/lead_bloc.dart';
import 'package:airdroper_crm/bloc/user_bloc.dart';
//import 'package:dropdown_search/dropdown_search.dart';
import 'package:flutter/material.dart';
import 'package:airdroper_crm/utils/utils.dart';
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                initialValue:
                                    userBloc.currentEditUser['first_name'],
                                cursorWidth: 3.0,
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                initialValue:
                                    userBloc.currentEditUser['last_name'],
                                cursorWidth: 3.0,
                                decoration: new InputDecoration(
                                  contentPadding: new EdgeInsets.symmetric(
                                      vertical: 15.0, horizontal: 10.0),
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              width: screenWidth * 0.92,
                              child: TextFormField(
                                initialValue: userBloc.currentEditUser['phone'],
                                decoration: new InputDecoration(
                                  contentPadding: new EdgeInsets.symmetric(
                                      vertical: 15.0, horizontal: 10.0),
                                  enabledBorder: buildBorder(Colors.black54),
                                ...
                                onSaved: (value) {
                                  userBloc.currentEditUser['phone'] = value;
                                },
                              ),
                            ),
                            _errors['phone'] != null
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                onSaved: (value) {
                                  userBloc.currentEditUser['alternate_email'] =
                                      value;
                                },
                              ),
                            ),
                            _errors['alternate_email'] != null
                                ? Container(
                                    margin: EdgeInsets.only(top: 5.0),
                                    alignment: Alignment.centerLeft,
                                    child: Text(
                                      _errors['alternate_email'][0],
                                      style: TextStyle(
                                          color: Colors.red[700],
                                          fontSize: 12.0),
                                    ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButtonFormField(
                                ...
                                value: userBloc.currentEditUser['role'],
                                onChanged: (value) {
                                  userBloc.currentEditUser['role'] = value;
                                },
                                items: userBloc.rolesObjForDropdown.map((item) {
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButtonFormField(
                                ...
                                value: userBloc.currentEditUser['status'],
                                onChanged: (value) {
                                  userBloc.currentEditUser['status'] = value;
                                },
                                items:
                                    userBloc.statusObjForDropdown.map((item) {
                                  return DropdownMenuItem(
                                    child: new Text(item),
                                    value: item,
                                  );
    ...
    return SingleChildScrollView(
        ...
        child: Form(
            ...
            child: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            initialValue:
                                userBloc.currentEditUser['address_line '],
                            decoration: new InputDecoration(
                              contentPadding: new EdgeInsets.symmetric(
                                  vertical: 15.0, horizontal: 10.0),
                              enabledBorder: buildBorder(Colors.black54),
                            ...
                            onSaved: (value) {
                              userBloc.currentEditUser['address_line '] = value;
                            },
                          ),
                        ),
                      ])),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: screenWidth * 0.92,
                          child: TextFormField(
                            initialValue: userBloc.currentEditUser['street'],
                            decoration: new InputDecoration(
                              contentPadding: new EdgeInsets.symmetric(
                                  vertical: 15.0, horizontal: 10.0),
                              enabledBorder: buildBorder(Colors.black54),
                            ...
                            onSaved: (value) {
                              userBloc.currentEditUser['street'] = value;
                            },
                          ),
                        ),
                      ])),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: screenWidth * 0.92,
                          child: TextFormField(
                            initialValue: userBloc.currentEditUser['city'],
                            decoration: new InputDecoration(
                              contentPadding: new EdgeInsets.symmetric(
                                  vertical: 15.0, horizontal: 10.0),
                              enabledBorder: buildBorder(Colors.black54),
                            ...
                            onSaved: (value) {
                              userBloc.currentEditUser['city'] = value;
                            },
                          ),
                        ),
                      ])),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: screenWidth * 0.92,
                          child: TextFormField(
                            initialValue: userBloc.currentEditUser['state'],
                            decoration: new InputDecoration(
                              contentPadding: new EdgeInsets.symmetric(
                                  vertical: 15.0, horizontal: 10.0),
                              enabledBorder: buildBorder(Colors.black54),
                            ...
                            onSaved: (value) {
                              userBloc.currentEditUser['state'] = value;
                            },
                          ),
                        ),
                      ])),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: screenWidth * 0.92,
                          child: TextFormField(
                            initialValue: userBloc.currentEditUser['pincode'],
                            decoration: new InputDecoration(
                              contentPadding: new EdgeInsets.symmetric(
                                  vertical: 15.0, horizontal: 10.0),
                              enabledBorder: buildBorder(Colors.black54),
                            ...
                            onSaved: (value) {
                              userBloc.currentEditUser['pincode'] = value;
                            },
                          ),
                        ),
                      ])),
              ...
              //                 onChanged: print,
              //                 selectedItem: userBloc.currentEditUser['country'],
              //                 showSearchBox: true,
              ...
              //                 },
              //                 onSaved: (newValue) {
              //                   userBloc.currentEditUser['country'] = newValue;
              //                 },
              //               )),
              //         ]))
            ]))));
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        // if (_userFormKey.currentState != null)
    ...
    if (_userFormKey.currentState != null) {
      ...
      if (_addressFormKey.currentState != null) {
        ...
        if (userBloc.currentEditUserId != null &&
          ...
          _result = await userBloc.createUser(file: file);
        }
        setState(() {
          _isLoading = false;
        });
