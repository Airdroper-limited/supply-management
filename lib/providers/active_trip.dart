...
class TripProvider with ChangeNotifier {
  ...
  LatLng? airdroperMarkerLatLng;

  LatLng getAirdroperDrivePosition(double animationValue) {
  ...
  void activateTrip(TripDataEntity trip) {
    ...
    drivingStateTimer = Timer(Duration(seconds: 3), () {
      ...
      drivingProgressTimer =
        ...
        airdroperMarkerLatLng = getAirdroperDrivePosition(drivingAnimationValue);
        notifyListeners();
      });
    });
